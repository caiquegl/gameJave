...
public class VariaveisFase1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(881, 634));
        setMinimumSize(new java.awt.Dimension(881, 634));
    ...
    private void ButtonEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEnviarActionPerformed
     ...
     if (!Movimento1.getText().equals("String move = ‘rigth’;")){
       ...
       if (Movimento1.getText().equals("String move = ‘rigth’;") && (Movimento2.getText().equals("String move = ‘down’;") && (Movimento3.getText().equals("String move = ‘left’;") && (Movimento4.getText().equals("String move = ‘down’;"))))){                  
        pt.setAddPontuacaoTotal(3000);
        UsuarioDAO dao = new UsuarioDAO();
        int totalPontuacao = pt.getPontuacaoTotal();
        dao.addPontuacao(totalPontuacao);
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 1/5.png")));
        JOptionPane.showMessageDialog(null, "Parabéns você chegou ao tesouro!!! iremos armazenar sua pontuação");   
