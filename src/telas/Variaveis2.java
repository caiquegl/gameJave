...
public class Variaveis2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ControllerPontuacao pt = new ControllerPontuacao();

     if (!Movimento1.getText().equals("String move = ‘rigth’;")){
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(100);
     }else if (!Movimento2.getText().equals("String move = ‘down’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/2.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(200);
     }else if (!Movimento3.getText().equals("String move = ‘left’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/3.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(300);
     }else if (!Movimento4.getText().equals("String move = ‘up’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/4.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(400);
     }else if (!Movimento5.getText().equals("String move = ‘rigth’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/5.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(500);
     }else if (!Movimento6.getText().equals("String move = ‘up’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/6.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(600);
     }else if (!Movimento7.getText().equals("String move = ‘left’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/7.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(700);
     }else if (!Movimento8.getText().equals("String move = ‘up’;")){
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/8.png")));
        JOptionPane.showMessageDialog(null, "Movimento errado!!!");
        pt.setRemovePontuacaoTotal(800);
     }
     ...
     if (Movimento1.getText().equals("String move = ‘rigth’;") && (Movimento2.getText().equals("String move = ‘down’;") && (Movimento3.getText().equals("String move = ‘left’;") && (Movimento4.getText().equals("String move = ‘up’;")) && (Movimento5.getText().equals("String move = ‘rigth’;")) && (Movimento6.getText().equals("String move = ‘up’;")) && (Movimento7.getText().equals("String move = ‘left’;")) && (Movimento8.getText().equals("String move = ‘up’;")) ))){                  
        mapa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/variaveis/fase 2/8.png")));
        pt.setAddPontuacaoTotal(4500);
        UsuarioDAO dao = new UsuarioDAO();
        int totalPontuacao = pt.getPontuacaoTotal();
        dao.addPontuacao(totalPontuacao);
